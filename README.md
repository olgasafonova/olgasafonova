...
- **[GitHub for Product People](https://olgasafonova.github.io/pm-github-training/github-for-product-people.html)** (Jul 2026) - 90-minute demo-driven session for [Women in Product Nordics](https://www.linkedin.com/company/women-in-product-nordics). Git and GitHub vocabulary for product people, a change shipped live through a pull request, and setup paths for local AI coding agents. No prior coding required.
- **[Build a Claude Code skill in 20 minutes](https://olgasafonova.github.io/pink-prog-meetup/presentation.html)** (May 2026) - [Pink Programming](https://pinkprogramming.se/) Malmö. What a skill is, its anatomy, building one live, then letting SkillCheck grade it.
- **[From Personal OS to Team OS](https://olgasafonova.github.io/ai-meetup-copenhagen/presentation.html)** (May 2026) - AI Meetup Copenhagen. How a personal AI workflow becomes team infrastructure: teach the AI the domain, version the rules, bring your own AI.
- **[Claude Code Stack with Opinions](https://olgasafonova.github.io/claude-code-meetup-malmo/presentation.html)** (May 2026) - [Claude Code for Developers](https://luma.com/fmnm8331), Malmö, part of Claude Community Events. The infrastructure around Claude Code, the MCP servers behind it, and the product domain as a machine-readable graph.
- **[AI That Does Things](https://olgasafonova.github.io/techlabs-talk/presentation.html)** (Mar 2026) - talk and live demos for [TechLabs Copenhagen](https://www.techlabs.org/). Covers MCP, compound AI systems, what fails in practice, and how to apply these tools to your own projects.
- **[Model Context Protocol](https://olgasafonova.github.io/mcp-workshop/presentation.html)** (Feb 2026) - the standard that lets AI assistants take action in your apps. 1-hour workshop covering what MCPs are, how to use them, and how to build them. Presented for [Women in Product Nordics](https://www.linkedin.com/company/women-in-product-nordics) & [TechWomen Copenhagen](https://www.linkedin.com/company/techwomen-copenhagen). Includes a GLEIF starter kit with platform-specific setup guides.
