...
- **[pm-github-training](https://olgasafonova.github.io/pm-github-training/github-for-product-people.html)** (Jul 2026) - "GitHub for Product People": 90-minute demo-driven session for [Women in Product Nordics](https://www.linkedin.com/company/women-in-product-nordics). Git and GitHub vocabulary for product people, a change shipped live through a pull request, and setup paths for local AI coding agents. No prior coding required.
- **[pink-prog-meetup](https://olgasafonova.github.io/pink-prog-meetup/presentation.html)** (May 2026) - "Build a Claude Code skill in 20 minutes": [Pink Programming](https://pinkprogramming.se/) Malmö. What a skill is, its anatomy, building one live, then letting SkillCheck grade it.
- **[ai-meetup-copenhagen](https://olgasafonova.github.io/ai-meetup-copenhagen/presentation.html)** (May 2026) - "From Personal OS to Team OS": AI Meetup Copenhagen. How a personal AI workflow becomes team infrastructure: teach the AI the domain, version the rules, bring your own AI.
- **[claude-code-meetup-malmo](https://olgasafonova.github.io/claude-code-meetup-malmo/presentation.html)** (May 2026) - "Claude Code Stack with Opinions": [Claude Code for Developers](https://luma.com/fmnm8331), Malmö, part of Claude Community Events. The infrastructure around Claude Code, the MCP servers behind it, and the product domain as a machine-readable graph.
