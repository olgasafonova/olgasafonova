...
- **[claude-code-meetup-malmo](https://olgasafonova.github.io/claude-code-meetup-malmo/presentation.html)** (May 2026) - "Claude Code Stack with Opinions": Malmö meetup. The infrastructure around Claude Code, the MCP servers behind it, and the product domain as a machine-readable graph.
